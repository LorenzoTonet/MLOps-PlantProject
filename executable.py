...
if "mean_sensors" not in st.session_state:
...
#         "temp": {"min": 15, "max": 30, "enabled": False},
#         "humid": {"min": 40, "max": 80, "enabled": False},
...
if st.session_state.monitoring:
    ...
    while st.session_state.monitoring:
        ...
        for sample in snapshot:
            ...
            if "plant_id" not in sample:
                print("Sample missing 'plant' key:", sample)
                continue
